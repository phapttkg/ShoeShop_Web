						...
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									...
									<div class="table-header">Results for "Product list"</div>
												...
												<c:forEach var="product" items="${listProduct }">
													<tr>
														...
														<c:forEach var="color" items="${listColor }">
															<c:if test="${color.id == product.id_color}">
																<td>${color.name }</td>
															</c:if>
														</c:forEach>
														...
														<c:forEach var="brand" items="${listBrand }">
															<c:if test="${brand.id == product.id_brand}">
																<td>${brand.name }</td>
															</c:if>
														</c:forEach>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																<a class="blue" href="view.do?id=${product.id}"> <i
																	class="ace-icon fa fa-search-plus bigger-130"></i>
																</a> <a class="green" href="edit.do?id=${product.id}"> <i
																	class="ace-icon fa fa-pencil bigger-130"></i>
																</a> <a class="red" href="delete.do?id=${product.id}"> <i

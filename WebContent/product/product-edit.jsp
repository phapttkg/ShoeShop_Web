...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/assets/css/bootstrap-timepicker.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/assets/css/daterangepicker.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/assets/css/bootstrap-datetimepicker.min.css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/assets/css/bootstrap-colorpicker.min.css" />
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Form edit product</li>
					</ul>
					<!-- /.breadcrumb -->
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" method="post"
								action="edit.do" enctype="multipart/form-data">
								<div class="form-group">
									<input hidden="" type="text" id="id" name="id"
										value="${product.id}"> <label
										class="col-sm-3 control-label no-padding-right" for="name">
										Name </label>

									<div class="col-sm-9">
										<input type="text" id="name" name="name"
											value="${product.name }" placeholder="Name"
											class="col-xs-10 col-sm-5" maxlength="20" required="required" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="file" id="image" name="image"
											class="col-xs-10 col-sm-5" accept="image/*"
											required="required" /> <img alt=""
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="number" id="price" name="price"
											value="${product.price }" min="1" max="999" step="any"
											pattern="[-+]?[0-9]*[.,]?[0-9]+" placeholder="Price"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="number" name="size" id="size"
											value="${product.size }" placeholder="Size" min="0" max="100"
											class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="id_color"> Color </label>
									<div class="col-sm-9">
										<select class="col-xs-10 col-sm-5" id="id_color"
											name="id_color">
											<c:forEach var="color" items="${listColor }">
												<c:choose>
													<c:when test="${color.id == product.id_color}">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="id_category"> Category </label>
									<div class="col-sm-9">
										<select class="col-xs-10 col-sm-5" id="id_category"
											name="id_category">
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="id_brand"> Brand </label>
									<div class="col-sm-9">
										<select class="col-xs-10 col-sm-5" id="id_brand"
											name="id_brand">
											<c:forEach var="brand" items="${listBrand }">
												<c:choose>
													<c:when test="${brand.id == product.id_brand}">
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="number" name="amount" id="amount"
											value="${product.amount }" placeholder="Size" min="0"
											max="1000000" class="col-xs-10 col-sm-5" />
									</div>
								</div>
...
<![endif]-->
	...
	<script
		src="${pageContext.request.contextPath }/assets/js/bootstrap-timepicker.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/assets/js/moment.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/assets/js/daterangepicker.min.js"></script>
	<script
	...
	<script
		src="${pageContext.request.contextPath }/assets/js/autosize.min.js"></script>
	<script
		src="${pageContext.request.contextPath }/assets/js/jquery.inputlimiter.min.js"></script>
	<script

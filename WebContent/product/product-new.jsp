			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Form new product</li>
					</ul>
					<!-- /.breadcrumb -->
						...
						<div class="col-xs-12">
							...
							<form class="form-horizontal" role="form" method="post"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="file" id="image" name="image"
											class="col-xs-10 col-sm-5" accept="image/*" required="required" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="number" id="price" name="price" min="1" max="999"
											step="any" pattern="[-+]?[0-9]*[.,]?[0-9]+"
											placeholder="Price" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="number" name="size" id="size" placeholder="Size"
											min="0" max="100" class="col-xs-10 col-sm-5" />
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="number" name="amount" id="amount"
											placeholder="Size" min="0" max="1000000"

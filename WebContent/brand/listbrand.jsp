				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<h3 class="header smaller lighter blue">Brand list</h3>

									<div class="clearfix">
										<div class="pull-right tableTools-container"></div>
									</div>
									<div class="table-header">Results for "Brand list"</div>
													...
													<tr>
														...
														<td>
															<div class="hidden-sm hidden-xs action-buttons">
																...
																</a> <a class="green" href="edit.do?id=${brand.id}"> <i
																	class="ace-icon fa fa-pencil bigger-130"></i>
																</a> <a class="red" href="delete.do?id=${brand.id}"> <i

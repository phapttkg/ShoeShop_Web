...
<%@ page import="com.coeding.mvc.vo.ProductVO"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body class="no-skin">
	<!-- LOAD DATA -->
	<%
	BillVO bill = (BillVO) request.getAttribute("bill");
	Object att = request.getAttribute("list");
	String[] list = ((String) att).split(",");
	%>
			...
			<div class="main-content-inner">
				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Form new Bill</li>
					</ul>
					<!-- /.breadcrumb -->
							...
							<form class="form-horizontal" role="form" method="post"
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="name"> Bill ID: </label>

									<div class="col-sm-9">
										<input type="number" id="bid" name="bid" placeholder="Bill ID"
											value="<%=bill.getBid()%>" class="col-xs-10 col-sm-5"
								...
								<div class="form-group">
									...
									<div class="col-sm-9">
										<input type="text" id="cName" name="cName"
											placeholder="Customer Name" value="<%=bill.getcName()%>"
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="id_color"> Product ID: </label>
									<div class="col-sm-9">
										<select class="col-xs-10 col-sm-5" id="Pid" name="Pid">
											<option value=<%=bill.getPid()%>><%=bill.getPid()%></option>
											<%
											for (String id : list) {
											%>
								...
								<div class="form-group">
									<label class="col-sm-3 control-label no-padding-right"
										for="size"> Amount </label>

									<div class="col-sm-9">
										<input type="number" name=amount id="amount"
											placeholder="amount" value="<%=bill.getAmount()%>" min="0"
											max="100" class="col-xs-10 col-sm-5" required="required" />
									</div>
								</div>

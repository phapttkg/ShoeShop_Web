		...
		<div id="sidebar"
			...
			<ul class="nav nav-list">
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						<li class=""><a
							href="${pageContext.request.contextPath }/admin/product/list.do"> <i
								class="menu-icon fa fa-caret-right"></i> Product list
						</a> <b class="arrow"></b></li>
					</ul>
					<ul class="submenu">
						<li class=""><a
							href="${pageContext.request.contextPath }/admin/bill/list.do"> <i
				...
				<li class=""><a href="#" class="dropdown-toggle"> <i
					...
					<ul class="submenu">
						<li class=""><a href="${pageContext.request.contextPath }/admin/product/new.do"> <i
								class="menu-icon fa fa-caret-right"></i> Form new product
						</a> <b class="arrow"></b></li>
					</ul>
					<ul class="submenu">
						<li class=""><a href="${pageContext.request.contextPath }/admin/bill/new.do"> <i
								class="menu-icon fa fa-caret-right"></i> Form new Bill
						</a> <b class="arrow"></b></li>
					</ul>
					</li>
			</ul>
							...
							<div class="profile-user-info profile-user-info-striped">
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span class="editable" id="username"><%=userVO.getUid()%></span>
									</div>
								</div>
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span class="editable" id="username"><%=userVO.getName()%></span>
									</div>
								</div>
								<div class="profile-info-row">
									...
									<div class="profile-info-value">
										<span class="editable" id="age"><%=userVO.getEmail()%></span>
									</div>
								</div>
							</div>

...
<meta charset="utf-8" />
<title>Login Page - ShoeShop</title>
			...
			<div class="row">
				<div class="col-sm-10 col-sm-offset-1">
					<div class="login-container">
						<div class="center">
							<h1>
								<i class="ace-icon fa fa-leaf green"></i> <span class="red">01</span>
								<span class="white" id="id-text2">WebServlet</span>
							</h1>
							<h4 class="blue" id="id-company-text">&copy; Team01</h4>
						</div>
							...
							<div id="login-box"
								...
								<div class="widget-body">
											...
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														...
														name="email" maxlength="40" required="required"/> <i class="ace-icon fa fa-user"></i>
												</span>
												</label> <label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="password" class="form-control"
														placeholder="Password" name="passwd" maxlength="40" required="required"/> <i
									...
									<div class="toolbar clearfix">
										<div>
											<a
												href="${pageContext.request.contextPath }/user/join.do"
												data-target="#signup-box" class="user-signup-link"> I
												want to register <i class="ace-icon fa fa-arrow-right"></i>
											</a>
										</div>
									</div>
								</div>
